...
proptest! {
    #[test]
    fn test_async_writer_futures_encode_then_decode(
    ...
    #[test]
    fn test_async_writer_futures_encode_with_split_then_decode(
    ...
    fn test_async_writer_futures_encode_without_table(
        ...
        futures::executor::block_on(async move {
            ...
            let table = read_seek_table(&mut futures::io::Cursor::new(&encoded[..])).await.unwrap();
